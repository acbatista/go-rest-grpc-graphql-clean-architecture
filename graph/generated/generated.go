...
type OrderResolver interface {
	CreatedAt(ctx context.Context, obj *domain.Order) (string, error)
	UpdatedAt(ctx context.Context, obj *domain.Order) (string, error)
}
...
func (ec *executionContext) _Order_customerName(ctx context.Context, field graphql.CollectedField, obj *domain.Order) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Order_total(ctx context.Context, field graphql.CollectedField, obj *domain.Order) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgoᚑrestᚑgrpcᚑgraphqlᚑcleanᚑarchitectureᚋinternalᚋdomainᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2ᚕᚖgoᚑrestᚑgrpcᚑgraphqlᚑcleanᚑarchitectureᚋinternalᚋdomainᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*domain.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgoᚑrestᚑgrpcᚑgraphqlᚑcleanᚑarchitectureᚋinternalᚋdomainᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgoᚑrestᚑgrpcᚑgraphqlᚑcleanᚑarchitectureᚋinternalᚋdomainᚐOrder(ctx context.Context, sel ast.SelectionSet, v *domain.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
